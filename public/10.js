...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/assets/src/components/4-2-Servicios.vue?vue&type=script&lang=js&":
/*!********************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/assets/src/components/4-2-Servicios.vue?vue&type=script&lang=js& ***!
  \********************************************************************************************************************************************************************************/
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      ...
      'ID_SERVICIOS', 'NOMBRE_SERVICIOS', 'TARIFA_SERVICIOS', 'TIPO_PERIODO', "accion"],
      options: {
        filterable: false,
        headings: {
          //modificado por el pasante 
          NOMBRE_SERVICIOS: "Servicios",
          TARIFA_SERVICIOS: "Tarifa",
  ...
  methods: {
    ...
    ListarRegistros: function ListarRegistros(page, buscar) {
      var me = this;
      var url = "/servicios/index?page=" + page + "&buscar=" + buscar;
    ...
    registrarNuevo: function registrarNuevo() {
      ...
      if (this.tituloaccion == "Guardar") {
        axios.post("/servicios/registrar", {
          NOMBRE_SERVICIOS: this.NOMBRE_SERVICIOS,
          TARIFA_SERVICIOS: this.TARIFA_SERVICIOS,
        ...
        axios.put("/servicios/actualizar", {
          id: this.ID_SERVICIOS,
          NOMBRE_SERVICIOS: this.NOMBRE_SERVICIOS,
          TARIFA_SERVICIOS: this.TARIFA_SERVICIOS,
          TIPO_PERIODO: this.TIPO_PERIODO
        }).then(function (response) {
    ...
    showModal: function showModal(accion, row) {
      ...
      switch (accion) {
        ...
        case 2:
          ...
          this.NOMBRE_SERVICIOS = row.NOMBRE_SERVICIOS, this.TARIFA_SERVICIOS = row.TARIFA_SERVICIOS, this.TIPO_PERIODO = row.TIPO_PERIODO, this.disabled = true;
          break;
    ...
    borrarFormulario: function borrarFormulario() {
      ...
      this.TARIFA_SERVICIOS = "";
      this.TIPO_PERIODO = "";
    },
    deleteRegistro: function deleteRegistro(idregistro) {
      var me = this;
      axios.post("/servicios/destroy", {
        id: idregistro
      }).then(function (response) {
        me.ListarRegistros(1, "");
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/assets/src/components/4-2-Servicios.vue?vue&type=template&id=72cc0fdf&":
/*!************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/assets/src/components/4-2-Servicios.vue?vue&type=template&id=72cc0fdf& ***!
  \************************************************************************************************************************************************************************************************************************/
                  ...
                  [
                    ...
                    _c(
                      "b-btn",
                      {
                        ...
                        on: {
                          click: function($event) {
                            return _vm.deleteRegistro(props.row.ID_SERVICIOS)
                          }
                        }
                      },
            ...
            [
              ...
              _c(
                ...
                [
                  _c(
                    ...
                    [
                      _c("b-input", {
                        ...
                        model: {
                          value: _vm.NOMBRE_SERVICIOS,
                          callback: function($$v) {
                            _vm.NOMBRE_SERVICIOS = $$v
                          },
                          expression: "NOMBRE_SERVICIOS"
                        }
                      })
                    ],
                    1
                  ...
                  _c(
                    "b-form-group",
                    { staticClass: "col-6", attrs: { label: "Tarifa" } },
                    [
                      _c("b-input", {
                        ref: "descripcion",
                        attrs: {
                        ...
                        model: {
                          value: _vm.TARIFA_SERVICIOS,
                          callback: function($$v) {
                            _vm.TARIFA_SERVICIOS = $$v
                          },
                          expression: "TARIFA_SERVICIOS"
                        }
                      })
                    ],
                    1
                  ...
                  _c(
                    "b-form-group",
                    { staticClass: "col-6", attrs: { label: "Periodo" } },
                    [
                      _c("b-input", {
                        ref: "descripcion",
                        attrs: {
                        ...
                        model: {
                          value: _vm.TIPO_PERIODO,
                          callback: function($$v) {
                            _vm.TIPO_PERIODO = $$v
                          },
                          expression: "TIPO_PERIODO"
                        }
                      })
                    ],
                    1
...
/***/ "./resources/assets/src/components/4-2-Servicios.vue":
/*!***********************************************************!*\
  !*** ./resources/assets/src/components/4-2-Servicios.vue ***!
  \***********************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _4_2_Servicios_vue_vue_type_template_id_72cc0fdf___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./4-2-Servicios.vue?vue&type=template&id=72cc0fdf& */ "./resources/assets/src/components/4-2-Servicios.vue?vue&type=template&id=72cc0fdf&");
/* harmony import */ var _4_2_Servicios_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./4-2-Servicios.vue?vue&type=script&lang=js& */ "./resources/assets/src/components/4-2-Servicios.vue?vue&type=script&lang=js&");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_5__["default"])(
  _4_2_Servicios_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _4_2_Servicios_vue_vue_type_template_id_72cc0fdf___WEBPACK_IMPORTED_MODULE_0__["render"],
  _4_2_Servicios_vue_vue_type_template_id_72cc0fdf___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/assets/src/components/4-2-Servicios.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/assets/src/components/4-2-Servicios.vue?vue&type=script&lang=js&":
/*!************************************************************************************!*\
  !*** ./resources/assets/src/components/4-2-Servicios.vue?vue&type=script&lang=js& ***!
  \************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_4_2_Servicios_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib??ref--4-0!../../../../node_modules/vue-loader/lib??vue-loader-options!./4-2-Servicios.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/assets/src/components/4-2-Servicios.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_4_2_Servicios_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/assets/src/components/4-2-Servicios.vue?vue&type=template&id=72cc0fdf&":
/*!******************************************************************************************!*\
  !*** ./resources/assets/src/components/4-2-Servicios.vue?vue&type=template&id=72cc0fdf& ***!
  \******************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_4_2_Servicios_vue_vue_type_template_id_72cc0fdf___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib??vue-loader-options!./4-2-Servicios.vue?vue&type=template&id=72cc0fdf& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/assets/src/components/4-2-Servicios.vue?vue&type=template&id=72cc0fdf&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_4_2_Servicios_vue_vue_type_template_id_72cc0fdf___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_4_2_Servicios_vue_vue_type_template_id_72cc0fdf___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
