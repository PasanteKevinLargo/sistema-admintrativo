      ...
      <template slot="accion" slot-scope="props">
        <div>
          ...
          <b-btn
            ...
            class="btn-xs"
            @click="deleteRegistro(props.row.ID_IVA)"
      ...
      >
        <div slot="modal-title">
          ...
          <!-- Modificado por el pasante -->
            ...
            <b-form-row>
              <b-form-group label="Codigo de SRI" class="col-12">
                <b-input
                  v-model="ID_CODSRI"
    ...
    showModal(accion, row) {
      ...
      switch (accion) {
        ...
        case 2:
          ...
          this.ID_CODSRI = row.ID_CODSRI,
          this.DESCRIPCION_IVA = row.DESCRIPCION_IVA,
          this.disabled = true;
