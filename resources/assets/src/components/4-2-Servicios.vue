      ...
      <template slot="accion" slot-scope="props">
        <div>
          ...
          <b-btn
            ...
            class="btn-xs"
            @click="deleteRegistro(props.row.ID_SERVICIOS)"
    ...
    <b-card-body>
      ...
      >
        <div slot="modal-title">
          {{ titulomodal1 }}
          <span class="font-weight-light">Servicios</span>
          <b-btn
            variant="outline-success borderless icon-btn"
            class="btn-m"
            @click="showModal(3, 0)"
          ...
          <!-- Modificado por el pasante -->
            ...
            <b-form-row>
              ...
              <b-form-group label="Tarifa" class="col-6">
                <b-input
                  v-model="TARIFA_SERVICIOS"
                  placeholder="tarifa"
                  ref="descripcion"
                  :disabled="disabled"
                />
              ...
              <b-form-group label="Periodo" class="col-6">
                <b-input
                  v-model="TIPO_PERIODO"
                  placeholder="Periodo"
                  ref="descripcion"
                  :disabled="disabled"
                />
    ...
    showModal(accion, row) {
      ...
      switch (accion) {
        ...
        case 2:
          ...
          this.NOMBRE_SERVICIOS = row.NOMBRE_SERVICIOS,
          this.TARIFA_SERVICIOS = row.TARIFA_SERVICIOS,
