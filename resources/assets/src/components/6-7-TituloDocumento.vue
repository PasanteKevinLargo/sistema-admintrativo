      ...
      <template slot="accion" slot-scope="props">
        <div>
          ...
          <b-btn
            ...
            class="btn-xs"
            @click="deleteRegistro(props.row.ID_TITULODOC)"
    ...
    <b-card-body>
      ...
      >
        <div slot="modal-title">
          {{ titulomodal1 }}
          <span class="font-weight-light">Titulo Documento</span>
          <b-btn
            variant="outline-success borderless icon-btn"
            class="btn-m"
            @click="showModal(3, 0)"
          ...
          <!-- Modificado por el pasante -->
            ...
            <b-form-row>
              ...
              <b-form-group label="Categoria" class="col-12">
                <b-input
                  v-model="CATEGORIA_TITULODOC"
  ...
  methods: {
    ...
    registrarNuevo() {
      ...
      if (this.tituloaccion == "Guardar") {
        axios
          .post("/titulodocumento/registrar", {
        ...
        axios
          .put("/titulodocumento/actualizar", {
    ...
    showModal(accion, row) {
      ...
      switch (accion) {
        ...
        case 2:
          ...
          this.DESCRIPCION_TITULODOC = row.DESCRIPCION_TITULODOC,
          this.CATEGORIA_TITULODOC = row.CATEGORIA_TITULODOC,
          this.disabled = true;
