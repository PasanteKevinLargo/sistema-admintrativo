      ...
      <template slot="accion" slot-scope="props">
        <div>
          ...
          <b-btn
            ...
            class="btn-xs"
            @click="deleteRegistro(props.row.ID_TITULO)"
    ...
    <b-card-body>
      ...
      >
        <div slot="modal-title">
          {{ titulomodal1 }}
          <span class="font-weight-light">Titulos</span>
          <b-btn
            variant="outline-success borderless icon-btn"
            class="btn-m"
            @click="showModal(3, 0)"
          ...
          <!-- Modificado por el pasante -->
            ...
            <b-form-row>
              <b-form-group label="TITULOS" class="col-12">
                <b-input
                  v-model="TITULO"
                  placeholder="Titulos"
                  ref="descripcion"
